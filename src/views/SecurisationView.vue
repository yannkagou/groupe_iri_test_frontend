<template>
    <div>
      <h1 class="text-2xl font-bold mb-4">Sécurisation de la donnée, interdiction de faire des captures</h1>
      <div v-if="!isScreenshotDetected">
      ...
      <div v-else>
        <p>La capture d'écran est détectée. Impossible d'accéder aux données sensibles.</p>
      </div>
    </div>
</template>
...
const isScreenshotDetected = ref(false);
